window.ISS = class {
    ...
    static get PORT_PMA_2() {
        return new Port("CONT",0, -0.8, 20.8, 90, 180, 0);
    }

    // Top highest
    static get PORT_MRM_2() {
        return new Port("CONT",0, 5.63, -19.9, 0, 0, 0);
    }

    // Bottom long extension
    static get PORT_MRM_1() {
        return new Port("NAME",0, -6.55, -6.9, 0, 0, 180);
    }

    // Bottom short extension
    static get PORT_DC_1() {
        return new Port("STAT",0, -4.4, -19.9, 0, 0, 180);
    }

    // End of spacecraft
    static get PORT_AFT() {
        return new Port("AFTC",0, 0.4, -32.0, 90, 0, 180);
    }
    ...
    static createSpacecraft(satelliteTracker, tle, progressCallback) {
        ...
        // Docking MYGOV satellites
        satellite.dock(46613, "Connect", ISS.PORT_AFT);
        satellite.dock(46613, "Online", ISS.PORT_DC_1);
        satellite.dock(46613, "ST MY001", ISS.PORT_MRM_1);
        satellite.dock(46920, "Malaysia", ISS.PORT_PMA_2);
        satellite.dock(46920, "Government", ISS.PORT_PMA_3);

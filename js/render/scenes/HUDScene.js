...
// ############ Right bottom buttons ############
    ...
    drawEarthFocusButton(x, y, size, mouseX, mouseY) {
        ...
        if (mouseOver) {
            this.drawRightText(x - 5, y + size / 2 + 4, "View " + (this.satelliteTracker.focusedEarth ? "Satellite" : "Earth"), '#ffffff', 20, false);
        }
    }
    ...
    drawDockingButton(x, y, size, mouseX, mouseY) {
        ...
        if (mouseOver) {
            this.drawRightText(x - 5, y + size / 2 + 4, (this.showDockingInformation ? "Hide" : "Show") + " MYGOV Satellite information", '#ffffff', 20, false);
        }
    }
...
// ############ Docking list ############
    ...
    drawDockingList(docking, x, y) {
        ...
        // Title
        this.drawText(x - maxValueLength - 10 - maxKeyLength, y, "MY-SATELLITE INFO", '#ffffff', false);
        y += fontSize + 5;
...
// ############ Telemetry ############
    ...
    drawTelemetry(satellite, x, y, width, height, date) {
        ...
        if (state.hasCrashed()) {
            ...
            this.drawCenteredText(x + 100 + (280 - 100) / 2, y + height - 8, " SYSTEM " + " POWERED BY " + satellite.name , '#999999', 14, false);
        }
    }
